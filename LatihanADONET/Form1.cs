    ...
    public partial class Form1 : Form
    {
        ...
        private SQLiteConnection GetOpenConnection()
        {
            ...
            try // penggunaan blok try-catch untuk penanganan error
            {
                ...
                string DbPerpustakaan = @"E:\22.11.4852\p8\Module Praktikum 08 (ADO.NET)\Module Praktikum 08 (ADO.NET)\LatihanADO.NET\Database\DbPerpustakaan.db";
                // deklarasi variabel connectionString, ref:https: www.connectionstrings.com/

                string connectionString = string.Format("Data Source = {0}; FailIfMissing = True", DbPerpustakaan);
